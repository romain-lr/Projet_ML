...
train_data_imputed <- train_data %>%  mutate_all(list(~ ifelse(is.na(.), mean(., na.rm = TRUE), .)))


#On vérifie qu'il n'y a plus de données manquantes
données_manquantes_train <- colSums(is.na(train_data_imputed))
print(données_manquantes_train)

fig <- plot_ly(x = names(données_manquantes_train), y = données_manquantes_train, type = "bar", 
               name = "Valeurs manquantes par variables", 
               marker = list(color = "purple"),
               xlab = "Variables", ylab = "Nombre de valeurs manquantes",
               title = "Valeurs manquantes par variables")
...
#On vérifie
données_manquantes_test <- colSums(is.na(test_data_imputed))
print(données_manquantes_test)

fig <- plot_ly(x = names(données_manquantes_test), y = données_manquantes_test, type = "bar", 
               name = "Valeurs manquantes par variables", 
               marker = list(color = "blue"),
               xlab = "Variables", ylab = "Nombre de valeurs manquantes",
               title = "Valeurs manquantes par variables (Données de test)")
